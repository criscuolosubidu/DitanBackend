...
class PreDiagnosisRecord(Base):
    ...
    record_id: Mapped[int] = mapped_column(Integer, ForeignKey("patient_medical_records.record_id"), nullable=False,
    ...
    # 关系
    medical_record: Mapped["PatientMedicalRecord"] = relationship("PatientMedicalRecord",
...
class SanzhenAnalysisResult(Base):
    ...
    pre_diagnosis_id: Mapped[int] = mapped_column(Integer, ForeignKey("pre_diagnosis_records.pre_diagnosis_id"),
